...
include "m3uParserPlayerVod.php";


if( isset($_SERVER['HTTPS'] ) ) {
    header("Location: http://{$_SERVER['HTTP_HOST']}/{$path}player/movie/");
    die();
}
...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo $nameIptv; ?> - Movie player</title>
        ...
        <link href="../css/styleMovie.css<?php echo "?".$version; ?>" rel="stylesheet">
        ...
        <script type="text/javascript" src="../js/CustomMovie/Designgen.js<?php echo "?".$version; ?>"></script>
        <script type="text/javascript" src="../js/CustomMovie/Additional.js<?php echo "?".$version; ?>"></script>
    ...
    <body>
        ...
        <!--- Body Content End--->
        <!-- MODAL CODE -->
        <div style="display: none; padding-right: 4px;" aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="menuModal" class="modal fade movie-popup in">
            <div class="modal-dialog modal-dialog-custom">		
            <div class="modal-content blur-background" id="modal-background">
                <div class="modal-header" style="border:0;"> 
                    <span class="p-close rippler rippler-default" data-dismiss="modal" aria-hidden="true" onclick="closeinfo()">x</span> 
                </div>
                <div class="modal-body no-blur-background">
                    <div class="popup-content">
                        <div class="col-sm-5 col-lg-2 col-md-2 col-xs-7">
                            <div class="poster">
                                <div class="poster-img"><img id="vod_img" src="" onerror="this.src='../images/no-poster.jpg';" alt="" class="img-responsive"></div>
                                <div class="ratting-bar row" id="vod_star_row">
                                    <div class="stars " style="text-align: center;" id="vod_star"></div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-7 col-lg-9 col-md-8 col-xs-12">
                            ...
                            <div class="poster-details">
                                ...
                                <ul class="col-md-6 col-sm-12">
                                    <li class="i-year" id="vod_year"></li>
                                    <li class="i-duration" id="vod_duration"></li>
                                    <li class="i-movie" id="vod_genere"></li>
                                    <!-- <li class="i-trailer"><a href="#">2018</a></li> -->
                                </ul>

                                <ul class="col-md-6 col-sm-12">
                                    <li class="i-cast" id="vod_cast_row" ><p id="vod_cast"></p></li>
                                    <li class="i-director" id="vod_director"></li>

                                    <!-- <li class="i-trailer"><a href="#">2018</a></li> -->
                                </ul>
                                <p class="pull-left" id="vod_description">
